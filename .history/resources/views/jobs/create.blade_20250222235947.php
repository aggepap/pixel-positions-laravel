...
<x-forms.input label="Salary" type="text" name="salary"  placeholder="e.g. $120,000" />
<x-forms.input label="Location" type="text" name="location"  placeholder="e.g. Boston MA, etc" />
